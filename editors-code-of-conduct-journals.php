...
<section class="commonbanner commonbanner42">
    <div class="container absolute-center">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <div class="banner-content">
                    <h1>Course on code of conduct for journals</h1>
                </div>
            </div>
        </div>
    </div>
...
<section cassl="white-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-12">
                <img src="assets/images/blog/183.webp" class="img-fluid" alt="">
            </div>
            <div class="col-lg-9 col-md-9 col-12">
                <h3 class="subheading mb-4">SpringerNature Code of Conduct page</h3>
...
<section class="gray-section">
    <div class="container">
        <div class="row mb-4">
            <h3 class="subheading border-white">Other e-learning courses</h3>
        </div>
        <div class="row">
            <div class="col-lg-3 col-md-6 col-12 mb-20">
                <div class="editors-wrapper">
                    <a href="information-guide.php">
                        <div class="editors-column bg-white">
