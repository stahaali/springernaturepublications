...
<section class="commonbanner commonbanner53">
    <div class="container absolute-center">
        <div class="row">
            <div class="col-lg-10 col-md-10 col-12">
                <div class="banner-content">
                    <h1>Course on Research Ethics</h1>
                </div>
            </div>
        </div>
    </div>
...
<section class="white-section">
    <div class="container">
        <div class="row">
            <h3 class="textblue3 mb-4">Research Ethics Module: 5 modules</h3>
                    ...
                    <a href="women-in-science.php">
                        <div class="initiative-column">
                            <div class="initiative-header">
                                <img src="assets/images/blog/232.webp" class="img-fluid" alt="" />
                            </div>
