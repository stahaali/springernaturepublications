...
<section class="commonbanner commonbanner55">
    <div class="container absolute-center">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <div class="banner-content">
                    <h1>Course on Plagiarism</h1>
                </div>
            </div>
        </div>
    </div>
...
<section class="white-section">
    <div class="container">
        <div class="row mb-4">
            <h3 class="textblue3">Plagiarism: 4 modules</h3>
        </div>
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-12">
                <div class="editors-wrapper border-radius">
                    <a href="information-guide.php">
                        <div class="editors-column">
                        <div class="editors-header"> 
                            <img src="assets/images/blog/239.webp" class="img-fluid" alt="">
                        </div>
                        <div class="editors-body">
                            <h4>Editing a journal</h4>
                            <p>This guide for Journal Editors provides an overview of the role of Editor-in-Chief, advice on setting up and maintaining an Editorial Board, how to launch and manage a journal as well as develop an existing journal to achieve its full potential.</p>
...
<section class="gray-section">
    <div class="container">
        <div class="row mb-4">
            <h3 class="subheading border-white">Download our Crossref guides</h3>
        </div>
        <div class="row">
            <div class="col-lg-4 col-md-4 col-12">
                <div class="row">
