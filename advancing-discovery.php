...
<style>
                ...
                <div class="col-lg-4 col-md-4  col-12">
                    <div class="p-wrapper">
                        <a href="#">
                            <div class="p-column">
                                <div class="p-header">
                                    <img src="assets/images/blog/16.webp" class="img-fluid" alt="">
                                </div>
                                    <div class="p-body">
    ...
    <section class="white-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <img src="assets/images/advancingdiscovery/1.webp" class="img-fluid" alt="">
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-12 m20">
                    <div class="advancingblog-column">
                        <div class="advancingblog-header1">
                            <img src="assets/images/advancingdiscovery/2.webp" class="img-fluid" alt="">
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="advanceresearch-img">
                        <img src="assets/images/banner/8.webp" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
