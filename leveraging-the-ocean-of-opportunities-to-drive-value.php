        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-10 col-md-10 col-12">
                    <div class="row">
                        <h3 class="subheading border-none">No shame, no blame – How to make retractions work</h3>
                    </div>
                    <div class="row mt-4 mb-4">
                        <div class="rdiv">
                            ...
                            <div class="rtext">
                                <p class="mb-0">Research Publishing</p>
                                <p class="mb-0">By: Tim Kersjes, Thu Aug 15 2024</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-5">
                        <div class="col-lg-8">
                            <p class="textinfo">The retraction of academic papers often functions as an indictment against the reputation of a researcher. Tim Kersjes argues that for retractions to function as an effective corrective to the scholarly record they need shed this punitive reputation.</p>
                        </div>
                        <div class="col-lg-4">
                            <div class="row align-items-center border-1 py-3">
                                <div class="col-lg-3">
                                    <img src="assets/images/blog/03.webp" class="img-fluid gray-scale" alt="">
                                </div>
                                <div class="col-lg-9">
                                    <p class="mb-0"><strong>Author: Tim Kersjes</strong></p>
                                    <p class="mb-0">Head of Research Integrity</p>
                                </div>
                            </div>
                        </div>
                        <p class="textinfo"> <i>Blog was originally published on the LSE Impact Blog and is re-published here with permission.</i> </p>
                    </div>

                    <div class="row">
                        <p>Retractions have a bad reputation. If an article gets retracted, it seems someone somewhere must have done something terribly wrong or even committed misconduct. Indeed, the number of retractions in 2023 was at an all time high, fuelled by publishers retracting thousands of papers that were published as a result of compromised special issues.</p>
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-8">
                            <img src="assets/images/blog/92.webp" class="img-fluid" alt="">
                        </div>
                    </div>

                    <div class="row border-1 py-3 mt-5">
                        <div class="col-lg-2">
                            <img src="assets/images/blog/03.webp" class="img-fluid gray-scale" alt="">
                        </div>
                        <div class="col-lg-10">
                            ...
                            <p>Tim Kersjes is the Head of Research Integrity, Resolutions at the Springer Nature Research Integrity Group. He is also a trustee at the Committee on Publication Ethics (COPE).</p>
                            <p>Tim has a background in philosophy (University of Groningen, Netherlands). After his studies he worked at a number of Dutch NGOs to promote innovation in democratic processes and civil society, and as a conference producer and training developer at International Institute for Research.</p>
                            <p>Before joining the Springer Nature Research Integrity Group in January 2017 he worked as a senior editor at Springer Nature subsidiary Rendement Uitgeverij, a multimedia publishing company specializing in content and advice on changes in legislation for professionals in SME companies.</p>
                        </div>
                    </div>
